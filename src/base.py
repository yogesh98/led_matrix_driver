...
class Base(object):
    def __init__(self, *args, **kwargs):
        ...
        self.parser.add_argument("-b", "--led-brightness", action="store", help="Sets brightness level. Default: 70. Range: 1..100", default=70, type=int)
        ...
        self.parser.add_argument("--led-rgb-sequence", action="store", help="Switch if your matrix has led colors swapped. Default: RGB", default="RBG", type=str)
    ...
    def run(self):
        print("Running, this function needs to be overridden")
